...
const Page = () => {
  ...
  <div className="absolute bg-black opacity-50 inset-0  z-10"/>
      ...
      <div className="relative z-10 flex lg:flex-row flex-col-reverse items-center lg:items-start justify-center lg:justify-center gap-6 lg:gap-10 w-full lg:w-full py-8 lg:py-0">
        <div className="bg-white/70 border border-white/20 rounded-[12px] p-6 sm:p-8 lg:p-12 w-full max-w-[534px]">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mt-4">
              ...
              <Link
                href="/sign-in"
                className="bg-transparent text-[14px] leading-[14px] flex items-center justify-center w-full sm:w-40 font-light rounded-full text-black py-4 px-5 border border-gray-300"
              >
                BACK TO LOGIN
              </Link>
            </div>
