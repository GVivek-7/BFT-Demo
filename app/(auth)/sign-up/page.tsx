...
const Page = () => {
  ...
  return (
    <div
      className="w-full min-h-screen bg-cover bg-center flex items-center justify-center md:justify-start md:px-50 px-4 pt-30"
      style={{
        backgroundImage:
        ...
        <div className="bg-white/70 border border-white/20 rounded-[12px] p-6 sm:p-8 lg:p-12 w-full max-w-[434px]">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-row items-center justify-center gap-3 sm:gap-4 mt-4">
              ...
              <Link
                href="/sign-in"
                className="bg-[#FFA62B] text-[14px] leading-[14px] flex items-center justify-center w-50 sm:w-40 font-light rounded-full text-white py-4 px-5"
              >
                LOG IN
              </Link>
            </div>
